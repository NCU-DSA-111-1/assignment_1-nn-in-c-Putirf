...
int num_layers;
int *num_neurons;
float alpha;//the number of learning rate
float *cost;
float full_cost;
float **input;
float **desired_outputs;
int num_training_ex;
int n=1;//times of compute cost
...
// Compute Total Cost //using Mean Squared Error function for computing error
